package Project_habib
  model Ev1 "Simulates a very basic Electric Vehicle"
    import Modelica;
  ...
  <p>Very basic introductory EV model</p>
      ...
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Ellipse(origin = {1, 1}, fillColor = {255, 0, 230}, fillPattern = FillPattern.Solid, extent = {{-91, 85}, {91, -85}})}),
  ...
  model Ev2 "Simulates a very basic Electric Vehicle"
    import Modelica;
    extends Modelica.Icons.Example;
    wbEHPTlib.SupportModels.Miscellaneous.DragForce dragF(Cx = 0.26, S = 2.2, fc = 0.014, m = mass.m, rho(displayUnit = "kg/m3") = 1.226) annotation(
  ...
  <p>Very basic introductory EV model with power measurements.</p>
      ...
      Commands,
      Diagram(coordinateSystem(extent = {{-120, -40}, {120, 40}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Rectangle(lineColor = {28, 108, 200}, pattern = LinePattern.Dash, extent = {{-84, 36}, {-24, 4}}), Text(lineColor = {28, 108, 200}, pattern = LinePattern.Dash, extent = {{-82, 2}, {-26, -4}}, textString = "electric drive")}),
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Ellipse(origin = {1, 1}, fillColor = {0, 98, 255}, fillPattern = FillPattern.Solid, extent = {{-91, 85}, {91, -85}})}),
      experiment(StartTime = 0, StopTime = 200, Tolerance = 0.0001, Interval = 0.1),
      __OpenModelica_simulationFlags(jacobian = "", s = "dassl", lv = "LOG_STATS"));
  end Ev2;
  
  model Ev3 "Simulates a very basic Electric Vehicle"
    import Modelica;
    extends Modelica.Icons.Example;
    ...
    Modelica.Mechanics.Rotational.Components.Inertia inertia(J = data.J) annotation(
      Placement(visible = true, transformation(extent = {{-54, 10}, {-34, 30}}, rotation = 0)));
  wbEHVpkg.VehicleData.Car data annotation(
  ...
  <p>Very basic introductory EV model</p>
      ...
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Ellipse(origin = {1, 1}, fillColor = {255, 238, 0}, fillPattern = FillPattern.Solid, extent = {{-91, 85}, {91, -85}})}),
      experiment(StartTime = 0, StopTime = 200, Tolerance = 0.0001, Interval = 0.1),
      __OpenModelica_simulationFlags(jacobian = "", s = "dassl", lv = "LOG_STATS"),
      __OpenModelica_commandLineOptions = "");
  end Ev3;
  
  model Ev4 "Simulates a very basic Electric Vehicle"
    import Modelica;
    extends Modelica.Icons.Example;
  ...
  <p>Simple map-based EV model with battery.</p>
      ...
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics = {Ellipse(origin = {1, 1}, fillColor = {4, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-91, 85}, {91, -85}})}),
    ...
    package PSD
      model PSecu1 "Full Power Split Device power train using Map-Based components"
        ...
        wbEHPTlib.SupportModels.Miscellaneous.PropDriver driver(CycleFileName = "NEDC.txt", k = 1, yMax = 1.8) annotation(
          Placement(visible = true, transformation(extent = {{-72, -48}, {-52, -28}}, rotation = 0)));
      equation
        connect(ECU.tauRef, driver.tauRef) annotation(
          Line(points = {{-22, -41}, {-29, -41}, {-29, -38}, {-51, -38}}, color = {0, 0, 127}));
        connect(carVel.v, driver.V) annotation(
          Line(points = {{78, -23}, {78, -58}, {-62, -58}, {-62, -49}}, color = {0, 0, 127}));
